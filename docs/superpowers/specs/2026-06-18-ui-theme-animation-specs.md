...
| 缓动 | `cubic-bezier(0.22, 1, 0.36, 1)` — 标准 enter 曲线，陡峭起始 + 柔和沉降 |
...
|------------|------|----------|--------|---------|
| 页面切换 (enter) | opacity + translateY(8px→0) | 300ms | `cubic-bezier(0.22, 1, 0.36, 1)` | instant |
| 页面切换 (leave) | opacity (1→0) | 200ms | `cubic-bezier(0.22, 1, 0.36, 1)` | instant |
| 卡牌选中 | scale(1→1.02) + glow | 200ms | `cubic-bezier(0.22, 1, 0.36, 1)` | instant |
