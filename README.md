...
**在线体验**：[msgs.jdtin.icu](https://msgs.jdtin.icu/) —— 手机端打开效果最佳

`Vue 3.5` · `Vite 6` · `Pinia 3` · `reka-ui` · 移动端优先
...
- 位置可拖动吸附并在视口变化时自动归位；主页有隐藏态（只露一角，避免挡住卡片堆叠），隐藏态下单击照样当场唤起搜索，无需先点醒再点一次
