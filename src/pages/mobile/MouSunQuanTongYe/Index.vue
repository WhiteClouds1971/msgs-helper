...
import bannerUrl from '@/assets/images/mobile/统业.webp'
...
<template>
  <div class="mou-sun-quan-tong-ye">
    <ImageFigure
      class="mou-sun-quan-tong-ye__figure"
      :src="bannerUrl"
      alt="统业"
    />
  </div>
