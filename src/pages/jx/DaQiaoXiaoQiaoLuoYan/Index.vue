...
import bannerUrl from '@/assets/images/jx/落雁.webp'
...
<template>
  <div class="da-qiao-xiao-qiao-luo-yan">
    <ImageFigure
      class="da-qiao-xiao-qiao-luo-yan__figure"
      :src="bannerUrl"
      alt="大乔＆小乔 落雁"
    />
  </div>
...
.da-qiao-xiao-qiao-luo-yan__figure {
  margin: auto;
}
</style>
