...
import bannerUrl from '@/assets/images/ol/燃己.webp'
...
<template>
  <div class="mou-jiang-wei-ran-ji">
    <ImageFigure
      class="mou-jiang-wei-ran-ji__figure"
      :src="bannerUrl"
      alt="燃己"
    />
  </div>
