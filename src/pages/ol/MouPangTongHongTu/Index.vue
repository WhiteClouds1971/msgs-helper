...
import bannerUrl from '@/assets/images/ol/鸿图.webp'
...
<template>
  <div class="mou-pang-tong-hong-tu">
    <ImageFigure
      class="mou-pang-tong-hong-tu__figure"
      :src="bannerUrl"
      alt="鸿图"
    />
  </div>
