...
import bannerUrl from '@/assets/images/jxtp/激将.webp'
...
<template>
  <div class="jie-liu-bei-ji-jiang">
    <ImageFigure
      class="jie-liu-bei-ji-jiang__figure"
      :src="bannerUrl"
      alt="激将"
    />
  </div>
